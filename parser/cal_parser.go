...
// CalParser rules.
const (
	CalParserRULE_prog = 0
	CalParserRULE_stat = 1
...
func NewEmptyProgContext() *ProgContext {
	...
	p.RuleIndex = CalParserRULE_prog
	return p
}
...
func (p *CalParser) Prog() (localctx IProgContext) {
	localctx = NewProgContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 0, CalParserRULE_prog)
	var _la int
	...
	for ok := true; ok; ok = (((_la)&-(0x1f+1)) == 0 && ((1<<uint(_la))&((1<<CalParserT__1)|(1<<CalParserID)|(1<<CalParserINT)|(1<<CalParserNEWLINE))) != 0) {
		{
			p.SetState(6)
			p.Stat()
		}
...
func NewEmptyStatContext() *StatContext {
	...
	p.BaseParserRuleContext = antlr.NewBaseParserRuleContext(nil, -1)
	p.RuleIndex = CalParserRULE_stat
	return p
}
...
func (s *BlankContext) NEWLINE() antlr.TerminalNode {
	return s.GetToken(CalParserNEWLINE, 0)
}
...
func (s *AssignContext) ID() antlr.TerminalNode {
	return s.GetToken(CalParserID, 0)
}
...
func (p *CalParser) Stat() (localctx IStatContext) {
	localctx = NewStatContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 2, CalParserRULE_stat)
...
func (s *MulDivContext) MUL() antlr.TerminalNode {
	return s.GetToken(CalParserMUL, 0)
}

func (s *MulDivContext) DIV() antlr.TerminalNode {
	return s.GetToken(CalParserDIV, 0)
}
...
func (s *AddSubContext) ADD() antlr.TerminalNode {
	return s.GetToken(CalParserADD, 0)
}

func (s *AddSubContext) SUB() antlr.TerminalNode {
	return s.GetToken(CalParserSUB, 0)
}
...
func (s *IntContext) INT() antlr.TerminalNode {
	return s.GetToken(CalParserINT, 0)
}
		...
		if _alt == 1 {
			...
			case 1:
				...
				}
				{
					...
					if !(_la == CalParserMUL || _la == CalParserDIV) {
			...
			case 2:
				...
				}
				{
					...
					if !(_la == CalParserADD || _la == CalParserSUB) {
						var _ri = p.GetErrorHandler().RecoverInline(p)
